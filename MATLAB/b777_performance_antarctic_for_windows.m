...
% modified for Windows - MS - Jan 27, 2025
...
% BedMachine v3
BM							= struct;
BM.x						= double(ncread('BedMachineAntarctica-v3.nc', 'x'))'; % projected x, m
BM.y						= double(flipud(ncread('BedMachineAntarctica-v3.nc', 'y'))); % projected y, m
BM.mask						= double(rot90(ncread('BedMachineAntarctica-v3.nc', 'mask'))); % mask
...
moa_cl                      = shaperead('moa_2009_coastline_v1.1.shp');
moa_gl                      = shaperead('moa_2009_groundingline_v1.1.shp');
moa_il                      = shaperead('moa_2009_islands_v1.1.shp');
...
[~, moa_ref]				= readgeoraster('moa750_2009_hp1_v1.1.tif');
...
target                      = kml2struct('2019_Antarctic_targets.kml');
